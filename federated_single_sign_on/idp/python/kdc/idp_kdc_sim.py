...
LOCAL_PORT = 50002  # Define port number
IP = "127.0.0.1"  # get IP address of the KSIM Server
...
if __name__ == '__main__':
    try:
        ...
        s.listen(5)
        print('KDC Simulation Server started at: ', IP)
